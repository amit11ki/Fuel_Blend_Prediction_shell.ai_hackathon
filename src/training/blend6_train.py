...
class Blend6Trainer:
    ...
    def train():
        ...
        """
        print("Starting training for BlendProperty6...")
        ...
        df_train_fe = Blend6Trainer.apply_feature_engineering(df_train)
        
        # Define features and target for BlendProperty6
        target_col = 'BlendProperty6'
        ...
        model_dir = Path(__file__).parent.parent.parent / 'models' / 'Blend-6'
        model_dir.mkdir(parents=True, exist_ok=True)
        model_filename = model_dir / 'model_BlendProperty6.joblib'
        joblib.dump(model, model_filename)
        print(f"Training complete. Model for BlendProperty6 saved to '{model_filename}'.")
