...
class Blend1Trainer:
    ...
    def train():
        ...
        """
        print("Starting training for BlendProperty1...")
        ...
        df_train_fe = Blend1Trainer.apply_feature_engineering(df_train)
        
        # Define features and target for BlendProperty1
        target_col = 'BlendProperty1'
        ...
        # Save the trained model in the models/Blend-1 directory
        model_dir = Path(__file__).parent.parent.parent / 'models' / 'Blend-1'
        model_dir.mkdir(parents=True, exist_ok=True)
        model_filename = model_dir / 'model_BlendProperty1.joblib'
        joblib.dump(model, model_filename)
        print(f"Training complete. Model for BlendProperty1 saved to '{model_filename}'.")
